export default {
    common: {
        ...
        landing: {
            ...
            seoContent: {
                ...
                faq: {
                    ...
                    q2: "這是一個教會官方的應用程式嗎？",
                    a2: "本Web應用程式並非耶穌基督後期聖徒教會官方軟體，而是個人為支援經文研讀而開發的非營利工具。我們不顯示廣告、不轉售數據，也不向用戶收取任何費用——任何人都可以完全免費使用。",
                    q3: "支援《利阿賀拿》和總會大會嗎？",
                    a3: "是的。除了標準經文之外，您也可以分享從《利阿賀拿》雜誌和總會大會中學到的心得與啟發。"
                }
            }
        },
        sidebar: {
        ...
        story: {
            ...
            backgroundStory: "哈囉，我是相根兄弟。我製作 Scripture Habit 是作為學校專案的一部分。在開發初期，我想著：「好吧，如果能做出一個可以交差的學校作業就好了。」然而，沒想到做出了比預期好很多的成品，因此最終促成了這款應用程式的實際公開發布。\n\n非常感激的是，透過這個應用程式，有些人告訴我：「研讀聖典變得很有趣」以及「我的靈性學習加深了」。我也想藉此機會表達我的感謝。我自己也因為這個應用程式，獲得了傳道和施助的寶貴機會。\n\n我自己每天都面臨著考驗與磨難，我想正在閱讀這段文字的每位讀者，也都在面臨著某些考驗與磨難。雖然我無法想像那些考驗與磨難究竟如何，但我衷心希望，研讀聖典以及在 Scripture Habit 上一起學習的夥伴們所留下的鼓勵留言，能成為各位心靈的支柱，並帶來靈性上的滋養。\n\n而在那些時刻，我們便會想起 Scripture Habit 的主題聖句：\n\n「宣講者和接受者彼此了解，雙方都得到啟發並一起歡欣。」\n\n希望這款應用程式能成為體現這句聖句所記喜悅的助力。\n\n最後，我由衷感謝所有支持這款應用程式開發的人，以及所有使用這款應用程式的人。願主豐富的祝福臨到你們的生活。\n\n非常期待您的意見與感想！！\n->dazhilangxianggen@gmail.com \n\n相根 大治郎",
            developerName: "相根 大治郎 (相根兄弟)",
        ...
        titleStep2: "累計學習天數",
        descStep2: "追蹤您的每日經文研讀累計天數，讓良好的習慣持續下去！",
        titleStep3: "等級與進度",
