export default {
    ...
    welcomeStory: {
        ...
        page3RuleContent1: "Để xây dựng thói quen nhóm, có một lời hứa là sẽ <strong style='color: #E53E3E;'>chia sẻ những gì bạn học được ít nhất 3〜7 ngày một lần.</strong>",
