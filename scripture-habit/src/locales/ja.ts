export default {
        ...
        landing: {
            hero: {
                title: "聖典学習を\n楽しく、習慣に",
                subtitle: "仲間と一緒に聖典を読み、気づきを分かち合うことで、毎日の学びがもっと楽しくなります。",
                cta: "今すぐはじめる",
                mascotBubble: "こんにちは！一緒に聖典を読み始めましょう！✨"
            },
            concept: {
                title: "ひとりで聖典を読み続けるのは、少し大変ですよね。",
            ...
            steps: {
                title: "Scripture Habit の使い方はとてもシンプルです",
                step1Title: "1. グループに入ってみる",
                step1Desc: "モルモン書や新約聖書など、自分が読みたい聖典の学習目標に合わせたグループに参加します。",
