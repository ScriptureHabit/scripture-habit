export default {
        ...
        story: {
            ...
            backgroundStory: "こんにちは、相根兄弟です。学校の課題の一環でScripture Habitを作成しました。開発当初は「まぁ、なんとか学校に提出できるものを作れればいいかな」と思ってました。ところが思いのほか良いものができてしまったので、実際にこれを公開するに至りました。\n\nありがたいことにこのアプリを通して、「聖典学習が楽しくなった」、「霊的な学びが深まった」と仰ってくれる方々がいます。この場を借りてこちらからも感謝を申し上げます。私自身、このアプリを通じて伝道、ミニスタリングの機会に恵まれました。\n\n私自身、日々試練と艱難に直面しておりますが、これを読んでる皆さんもなんらかの試練、艱難に直面してると想像します。その試練、艱難がどのようなものか、私には想像も及びませんが、聖典及び、Scripture Habitで一緒に勉強してる人のコメントによる励ましが皆さんの心の支えとなり、霊的な養いになることを心より願っております。\n\nそしてその時、Scripture Habitのテーマ聖句を私たちは思い返すのです。\n\n「それゆえ、説く者と受ける者は互いに理解し合い、ともに教化されて、ともに喜ぶのである。」\n\nこのアプリがこの聖句が記す喜びを体現する一助になれば幸いです。\n\n最後にこのアプリ開発を支えてくれたすべての方々、ならびにこのアプリを使ってくださるすべての方々に心から感謝を申し上げます。皆様の人生に主の豊かな祝福がありますように。\n\nご意見ご感想お待ちしてます！！\n->dazhilangxianggen@gmail.com \n\n相根 大治郎",
        ...
        landing: {
            ...
            seoContent: {
                faq: {
                    ...
                    a1: "一日に一度聖典学習をする時間を作ること、学んだことを分かち合うことが大切です。Scripture Habitでお互いに励まし合いながら少しずつ頑張っていきましょう。",
                    q2: "このアプリは教会公式のものですか？",
                    a2: "本Webアプリは末日聖徒イエスキリスト教会公式のものではありませんが、聖典学習を支援するために個人で開発された非営利のツールです。広告の表示、データの販売、ユーザーへの料金請求は一切行っておらず、誰でも無料でご利用できます。",
                    q3: "リアホナや総大会には対応してますか？",
                    a3: "はい。四大聖典のみならず、リアホナや総大会から学んだことも分かち合うこともできます。"
                }
            }
        }
};
