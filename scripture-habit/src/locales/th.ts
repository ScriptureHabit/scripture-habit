export default {
    common: {
        ...
        story: {
            ...
            backgroundStory: "สวัสดีครับ ผมบราเดอร์ซากาเนะครับ ผมสร้าง Scripture Habit ขึ้นมาโดยเป็นส่วนหนึ่งของโครงงานโรงเรียน ในช่วงเริ่มต้นของการพัฒนา ผมคิดว่า 'ก็ดีนะถ้าผมสามารถทำอะไรสักอย่างที่พอจะส่งครูที่โรงเรียนได้' อย่างไรก็ตาม ผลลัพธ์กลับออกมาดีกว่าที่ผมคาดไว้มาก ผมจึงตัดสินใจเปิดตัวสู่สาธารณะจริงในที่สุด\n\nรู้สึกซาบซึ้งใจมากครับที่ผ่านแอปนี้ มีผู้คนบอกกับผมว่า 'การศึกษาพระคัมภีร์กลายเป็นเรื่องสนุก' และ 'การเรียนรู้ทางวิญญาณของฉันลึกซึ้งยิ่งขึ้น' ผมอยากจะใช้โอกาสนี้เพื่อแสดงความขอบคุณด้วยเช่นกัน ตัวผมเองก็ได้รับพรด้วยโอกาสในการทำงานเผยแผ่ศาสนาและการปฏิบัติศาสนกิจผ่านแอปนี้\n\nตัวผมเองต้องเผชิญกับการทดลองและความทุกข์ยากในทุกๆ วัน และผมคิดว่าทุกท่านที่กำลังอ่านข้อความนี้อยู่ก็น่าจะกำลังเผชิญกับการทดลองและความทุกข์ยากบางอย่างเช่นกัน แม้ว่าผมจะไม่สามารถจินตนาการได้เลยว่าการทดลองและความทุกข์ยากเหล่านั้นเป็นอย่างไร แต่ผมหวังเป็นอย่างยิ่งว่าพระคัมภีร์และแรงใจจากความคิดเห็นของผู้ที่ศึกษาด้วยกันใน Scripture Habit จะเป็นที่ยึดเหนี่ยวจิตใจและช่วยบำรุงเลี้ยงจิตวิญญาณของทุกท่าน\n\nและในเวลานั้น เราจะระลึกถึงพระคัมภีร์หัวข้อหลักของ Scripture Habit เสมอ:\n\n\"ดังนั้น, คนที่สั่งสอนและคนที่รับ, ย่อมเข้าใจกัน, และทั้งสองได้รับการจรรโลงใจและชื่นชมยินดีร่วมกัน.\"\n\nหวังว่าแอปนี้จะเป็นส่วนหนึ่งในการช่วยถ่ายทอดความชื่นชมยินดีที่พระคัมภีร์ข้อนี้ได้กล่าวไว้ครับ\n\nสุดท้ายนี้ ผมขอขอบคุณจากใจจริงสำหรับทุกๆ ท่านที่สนับสนุนการพัฒนาแอปนี้ และทุกๆ ท่านที่ใช้งานแอปนี้ ขอให้พระพรของพระผู้เป็นเจ้าสถิตอยู่กับชีวิตของทุกท่านอย่างเหลือล้นครับ\n\nรอรับฟังความคิดเห็นและความรู้สึกของทุกท่านอยู่นะครับ!!\n->dazhilangxianggen@gmail.com \n\nไดจิโร ซากาเนะ",
            developerName: "ไดจิโร ซากาเนะ (บราเดอร์เซน)",
        ...
        titleStep2: "จำนวนวันสะสม",
        descStep2: "ติดตามจำนวนวันสะสมของการศึกษาพระคัมภีร์อย่างต่อเนื่องในแต่ละวัน เพื่อคงนิสัยที่ดีไว้!",
