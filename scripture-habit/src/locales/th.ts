export default {
    ...
    landing: {
        ...
        seoContent: {
            ...
            faq: {
                ...
                a1: "วิธีที่ดีที่สุดในการเริ่มนิสัยการอ่านพระคัมภีร์คือเริ่มจากจุดเล็กๆ และทำอย่างสม่ำเสมอ กฎ 3 วันของ Scripture Habit ช่วยให้คุณรักษาจังหวะที่มั่นคงได้โดยไม่รู้สึกกดดันจนเกินไป",
                ...
                q3: "ฉันสามารถใช้แอปนี้เพื่อศึกษาพระคัมภีร์ไบเบิลได้หรือไม่?",
                a3: "แน่นอน! Scripture Habit ได้รับการออกแบบมาสำหรับการศึกษาพระคัมภีร์ใดๆ รวมถึงพระคัมภีร์ไบเบิล (พันธสัญญาเดิมและพันธสัญญาใหม่) พระคัมภีร์มอรมอน และข้อความศักดิ์สิทธิ์อื่นๆ"
            }
        }
    },
    sidebar: {
    ...
    welcomeStory: {
        ...
        page3RuleContent1: "เพื่อสร้างนิสัยของกลุ่ม เรามีสัญญาที่จะ <strong style='color: #E53E3E;'>แบ่งปันการเรียนรู้ของคุณอย่างน้อยหนึ่งครั้งทุก 3〜7 วัน</strong>",
