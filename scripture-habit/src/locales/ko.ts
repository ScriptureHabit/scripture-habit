    ...
    common: {
        ...
        landing: {
            ...
            features: {
                ...
                sharing: {
                    title: "마음을 잇는 공유 기능",
                    desc: "가족이나 친구들과 학습 진도를 나누며 서로 응원하고 더욱 깊은 배움을 나눌 수 있습니다."
                },
                rule: {
                    title: "따뜻하게 돕는 습관 규칙",
                    desc: "일정 기간 동안 글을 올리지 않으면 잠시 그룹 활동을 쉬어가는 친근한 규칙을 함께 극복하며 평생 지속되는 습관을 길러보세요."
                },
                ai: {
                    title: "마음을 전하는 주간 편지",
                    desc: "매주 한 번, 한 주간의 배움을 따뜻하게 정리한 리포트 편지가 도착하여 나의 배움을 소중히 돌아보도록 돕습니다."
                },
                link: {
                    title: "복음 라이브러리 연동",
                    desc: "복음 라이브러리와 BYU Speeches로 언제든지 바로 이동하여 읽고 싶은 성구를 손쉽게 열어볼 수 있습니다."
                },
                recommend: {
                    title: "선물 같은 성구 추천",
                    desc: "오늘의 와서 나를 따르라 범위나 지금 내 마음 상태에 알맞은 평화로운 성구를 언제든 마음껏 받아보세요."
                }
            },
            useCases: {
                title: "주일학교를 더욱 깊이 있고 즐겁게",
                status: {
                    problem: "이전의 고민들",
                    solution: "Scripture Habit을 쓰고 나서"
                },
                teacher: {
                    title: "교사를 위해",
                    problem: "평소 학생들이 평일에 어떻게 경전을 읽고 있는지 알기 어려워 각자에게 꼭 맞는 수업을 준비하기가 쉽지 않았습니다.",
                    solution: "학생들이 평일에 느낀 생각이나 궁금증을 미리 파악함으로써, 한 사람 한 사람에게 깊이 와닿는 따뜻한 공과를 준비할 수 있습니다."
                },
                student: {
                    title: "학생을 위해",
                    problem: "바쁜 하루를 보내다 보면 경전 읽기가 밀리기 십상이었고, 혼자서는 공부 의지를 꾸준히 이어가기가 어려웠습니다.",
                    solution: "같은 뜻을 지닌 동료들과 마음을 나누며 공부하다 보면 매일 경전을 읽는 시간이 손꼽아 기다려집니다."
                }
            },
            unity: {
                title: "서로의 마음을 잇다",
                desc: "모임의 모든 동료가 그날의 독서를 완료하면, 아름다운 일출 그림을 만날 수 있습니다."
            },
            finalCta: {
            ...
            seoContent: {
                why: {
                    title: "왜 경전 공부를 습관으로 만들어야 할까요?",
                    text: "매일 조금씩이라도 경전을 접하는 것은 개인적인 계시를 받고 영적으로 성장하는 확실한 주춧돌이 됩니다."
                },
                community: {
                    title: "함께 배우는 소중한 힘",
                    text: "가족이나 친구들과 작은 모임에서 하루의 소감을 나누면, 지치지 않고 즐겁게 경전 공부를 계속할 수 있습니다."
                },
                comparison: {
                    title: "기쁨으로 이어가는 경전 독서",
                    text: "Scripture Habit은 따뜻한 주간 리포트와 부드러운 약속을 통해 동료들과 함께 습관을 만들 수 있도록 응원합니다."
                },
                faq: {
                    title: "자주 묻는 질문",
                    q1: "경전 공부를 어떻게 계속할 수 있나요?",
                    a1: "하루에 한 번 경전을 공부하는 시간을 만들고, 배운 것을 나누는 것이 중요합니다. Scripture Habit에서 서로를 격려하며 조금씩 힘내어 나아갑시다.",
                    q2: "이 앱은 교회 공식 앱인가요?",
                    a2: "본 웹앱은 예수 그리스도 후기 성도 교회의 공식 도구는 아니지만, 경전 공부를 지원하기 위해 개인이 개발한 비영리 도구입니다. 광고 표시, 데이터 판매, 사용자 비용 청구는 일절 하지 않으며, 누구나 완전히 무료로 이용할 수 있습니다.",
                    q3: "리아호나나 연차대회 말씀도 나눌 수 있나요?",
                    a3: "네. 표준 경전뿐만 아니라 리아호나 잡지나 연차대회 말씀에서 배운 생각과 느낌도 얼마든지 공유하고 나눌 수 있습니다."
                }
            }
        },
        sidebar: {
        ...
        story: {
            ...
            backgroundStory: "안녕하세요, 상근 형제입니다. 학교 과제의 일환으로 Scripture Habit을 제작했습니다. 개발 초기에는 '어떻게든 학교에 제출할 수 있는 수준으로 만들면 되겠지'라고 생각했습니다. 하지만 생각했던 것보다 훨씬 더 좋은 결과물이 만들어져서 실제로 이를 공개하게 되었습니다.\n\n감사하게도 이 앱을 통해 \"경전 공부가 즐거워졌다\", \"영적인 배움이 깊어졌다\"고 말씀해 주시는 분들이 계십니다. 이 자리를 빌려 저 역시 진심으로 감사의 말씀을 전하고 싶습니다. 저 자신도 이 앱을 통해 선교 사업과 성역의 기회를 누리는 축복을 받았습니다.\n\n저 또한 매일 시련과 고난에 직면해 있으며, 이 글을 읽고 계신 여러분도 어떠한 시련과 고난에 직면해 계실 것이라 생각합니다. 그 시련과 고난이 어떤 것인지 제가 감히 상상할 수도 없지만, 매일의 경전 공부와 Scripture Habit에서 함께 배우는 동료들의 격려 댓글이 여러분에게 큰 지탱이 되고 영적인 양식이 되기를 진심으로 바랍니다.\n\n그럴 때마다 우리는 Scripture Habit의 주제 성구를 떠올리게 됩니다.\n\n「그러므로 전하는 자나 받는 자가 서로 이해하며, 둘 다 덕을 세우며 함께 기뻐하느니라.」\n\n이 앱이 이 성구에 기록된 기쁨을 구현하는 데 조금이나마 도움이 되기를 바랍니다.\n\n마지막으로 이 앱 개발을 지원해 주신 모든 분들과 이 앱을 사용해 주시는 모든 분들께 진심으로 감사의 말씀을 드립니다. 여러분의 삶에 주님의 풍성한 축복이 함께하기를 바랍니다.\n\n의견이나 소감을 기다리고 있습니다!!\n->dazhilangxianggen@gmail.com \n\n상근 대지로",
            developerName: "다이지로 사가네 (상근 형제)",
