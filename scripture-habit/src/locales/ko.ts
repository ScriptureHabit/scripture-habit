export default {
    common: {
        ...
        landing: {
            hero: {
                title: "경전 공부가 즐거운 습관이 되는 곳",
                subtitle: "친구들과 함께 경전을 읽고 일상의 배움을 나누며 하루하루 공부하는 기쁨을 느껴보세요.",
                cta: "지금 시작하기",
                mascotBubble: "안녕하세요! 우리 함께 경전 읽기를 시작해 봐요! ✨"
            },
            concept: {
                title: "경전을 혼자서 계속 읽는 건 조금 힘들 수 있죠.",
            ...
            steps: {
                title: "Scripture Habit 사용법은 정말 간단합니다",
                step1Title: "1. 모임 참가하기",
                step1Desc: "몰몬경이나 신약전서와 같이 당신의 경전 목표에 맞는 모임에 참여합니다.",
            ...
            seoContent: {
                ...
                faq: {
                    ...
                    q2: "이 앱은 교회 공식 앱인가요?",
                    a2: "이 앱은 공식 앱이 아니며, 회원과 모든 경전 학습자를 지원하기 위해 개인이 개발한 비영리 도구입니다.",
                    q3: "성경 공부에도 사용할 수 있나요?",
                    a3: "네, 이 앱은 몰몬경과 신약전서를 비롯해 여러분이 소중히 여기는 모든 성경 공부를 완벽하게 지원합니다."
                }
            }
        },
        sidebar: {
