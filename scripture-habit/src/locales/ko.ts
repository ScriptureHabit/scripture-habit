export default {
    ...
    landing: {
        ...
        seoContent: {
            ...
            faq: {
                ...
                a1: "경전 습관을 시작하는 가장 좋은 방법은 작게 시작하여 꾸준히 하는 것입니다. Scripture Habit의 3일 규칙은 너무 압도당하지 않으면서도 일정한 리듬을 유지할 수 있도록 도와줍니다.",
                ...
                a3: "물론입니다! Scripture Habit은 성경(구약 및 신약), 몰몬경 및 기타 성스러운 기록을 포함한 모든 경전 공부를 위해 설계되었습니다."
            }
        }
    },
    sidebar: {
    ...
    welcomeStory: {
        ...
        page3RuleContent1: "그룹의 습관 형성을 위해, <strong style='color: #E53E3E;'>3〜7일에 한 번은 배운 내용을 공유한다</strong>는 약속이 있습니다.",
