...
import { getBookSuggestions, BookSuggestion } from './suggestion-utils';
...
describe('suggestionUtils', () => {
    ...
    describe('getBookSuggestions', () => {
        ...
        it('should filter books by English name (case-insensitive)', () => {
            ...
            expect(results.some((r: BookSuggestion) => r.english === '1 Nephi')).toBe(true);
            expect(results.some((r: BookSuggestion) => r.english === '2 Nephi')).toBe(true);
            expect(results.some((r: BookSuggestion) => r.english === '3 Nephi')).toBe(true);
            expect(results.some((r: BookSuggestion) => r.english === '4 Nephi')).toBe(true);
        });
