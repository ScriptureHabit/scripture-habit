export default {
    "milestone": {
        ...
        "label": "研讀記錄",
        "daysUnit": "DAYS",
        "speechBubbleLine1": "恭喜達成 {days} 天！🎉",
        "speechBubbleLine2": "太棒了！",
    ...
    "timeCapsule": {
        ...
        "socialProofChallengers": "世界各地的夥伴正朝著第 {days} 天努力邁進！",
        "letterSectionTitle": "寫給達成第 {days} 天時的自己",
        "letterSectionDesc": "寫下達成目標時的心情、感想以及給未來的鼓勵",
        "letterPlaceholder": "恭喜達成10天！一開始每天翻開經文可能有些挑戰，但你堅持下來了。繼續保持，一起開心地邁向第25天吧！",
        "sosSectionTitle": "偷懶警報：緊急 SOS 鼓勵話語",
        "sosSectionDesc": "在習慣快要中斷的日子裡，來自過去自己的初心與提醒",
        "sosPlaceholder": "回想一下當初想要透過經文讓心靈充實的初衷！今天哪怕只讀一節經文也是很大的進步！",
        "sealButton": "封存時光膠囊",
        "sealing": "封存中...",
        "sealedSuccess": "第 {days} 天的時光膠囊已成功封存！",
        "charCount": "{current}/{max} 字",
        "minCharWarning": "信件請至少輸入5個字，SOS提醒請至少輸入3個字",
        "unlockTitle": "時光膠囊開啟！",
        "unlockSubtitle": "恭喜達成第 {days} 天！過去的你寄來了一封信",
        "fromPastSelf": "來自過去自己的一封信",
        "createdOn": "撰寫日期：{date}（當時：第 {days} 天 / Lv.{level}）",
        "savedToLetterBoxArchive": "此信件已永久封存在你的信箱中",
        "writeNextLetter": "為第 {nextDays} 天寫下一封信",
        "cardNoLetterTitle": "尚未為第 {days} 天寫信",
        "cardNoLetterDesc": "給未來的自己送上一份加油打氣的訊息吧！",
        "writeLetterBtn": "撰寫信件",
        "cardSealedTitle": "第 {days} 天時光膠囊封存中",
    ...
    "apiErrors": {
        ...
        "EXPIRED_INVITE_LINK": "此邀請連結已過期。請向邀請您的群組成員索取新的連結。",
        "FORBIDDEN": "拒絕存取。",
        "NOT_FOUND": "找不到資源。",
    ...
    "story": {
        ...
        "personalStudyTitle": "個人經文研究",
        "personalStudyDesc": "開發者個人進行的經文（以賽亞書・摩爾門經）研究筆記已發布於GitHub（僅限日語）。有興趣的朋友歡迎參考查閱。",
        "isaiahTitle": "以賽亞書個人研究",
    ...
    "dashboard": {
        ...
        "rejoinGroupPrompt": "想再次加入「{groupName}」嗎？",
        "rejoinAiGroupPrompt": "想重啟你的 Scripture Habit AI 群組嗎？",
        "rejoinBtn": "重新加入",
        "rejoiningBtn": "加入中...",
        "findOrCreateOtherGroup": "尋找或建立其他群組",
        "rejoinSuccess": "已成功重新加入群組！",
        "groupFullRejoin": "抱歉，此群組目前人數已滿 💦",
        "groupDeletedRejoin": "此群組已被刪除。",
        "notificationPrompt": {
            "title": "保持聯繫！",
    ...
    "groupChat": {
        ...
        "inviteNoExpiration": "有效期限：無期限（隨時可加入）",
    ...
    "landing": {
        ...
        "concept": {
            ...
            "subtitle": "無論是與大家互相鼓勵，還是與AI一起按照自己的步調學習，都能自然養成持久的習慣。",
            "problemBadge": "難以繼續",
            "solutionBadge": "輕鬆又好玩！",
            "aiBadge": "一個人也安心！",
            "twoWaysLabel": "兩種持續學習的方式",
            "card1Title": "獨自研讀時...",
            "card1Text": "忙碌的生活容易讓閱讀擱置，不知不覺就會放棄。",
            "card2Title": "與溫暖的夥伴一起！",
            "card2Text": "透過彼此溫柔鼓勵，將所感受到的寫成文字，研讀自然會成為習慣。",
            "card3Title": "一個人就與AI同行！",
            "card3Text": "身邊沒有一起學習的朋友也沒關係。Scripture Habit AI每天都會發布筆記，隨時陪伴你按照自己的步調學習。"
        },
        "aiLetter": {
            "title": "一人學習也不孤單，AI 寄送的「回顧信件」",
            "subtitle": "每寫下兩篇筆記，AI 都會化身為經文中的人物，為你寫下一封溫暖且貼心的信件。"
        },
        "steps": {
            "title": "使用方法",
            "step1Title": "1. 建立小組",
            "step1Desc": "嘗試與想一起研讀經文的人，或是與 AI 建立一個群組吧。",
            "step2Title": "2. 分享你的所見",
