export default {
    "milestone": {
        ...
        "label": "학습 기록",
        "daysUnit": "DAYS",
        "speechBubbleLine1": "{days}일 달성을 축하해요! 🎉",
    ...
    "timeCapsule": {
        ...
        "socialProofCount": "지금까지 {count}명의 동료가 Day {days}를 달성했습니다!",
        "socialProofChallengers": "전 세계의 동료들이 Day {days}를 향해 도전 중입니다!",
        "letterSectionTitle": "Day {days}를 달성한 나에게 보내는 편지",
        "letterSectionDesc": "목표를 달성했을 때의 마음과 미래의 나를 향한 격려를 적어보세요",
        "letterPlaceholder": "10일 달성 축하해! 처음엔 매일 경전을 펼치는 게 쉽지 않았을 텐데, 포기하지 않고 여기까지 왔구나. 이 기세로 Day 25도 즐겁게 이어가자!",
        "sosSectionTitle": "작심삼일 위기 극복: 나만의 SOS 한마디",
        "sosSectionDesc": "습관이 끊길 것 같은 날 도착하는 과거의 나로부터의 응원 메시지입니다",
        "sosPlaceholder": "처음 시작할 때 경전으로 마음을 채우고 싶었던 그 마음을 기억해! 오늘 딱 1절만 읽어도 큰 승리야!",
        "sealButton": "타임캡슐 봉인하기",
        "sealing": "봉인 중...",
        "sealedSuccess": "Day {days} 타임캡슐이 봉인되었습니다!",
        "charCount": "{current}/{max}자",
        "minCharWarning": "편지 본문은 5자 이상, SOS 한마디는 3자 이상 입력해 주세요",
        "unlockTitle": "타임캡슐 개봉!",
        "unlockSubtitle": "Day {days} 달성을 축하합니다! 과거의 나로부터 편지가 도착했습니다",
        "fromPastSelf": "과거의 나로부터 온 편지",
        "createdOn": "작성일: {date} (당시: {days}일차 / Lv.{level})",
        "savedToLetterBoxArchive": "이 편지는 편지함에 영구 보관되었습니다",
        "writeNextLetter": "다음 Day {nextDays}의 나에게 편지 쓰기",
        "cardNoLetterTitle": "Day {days}에 보낼 편지가 아직 없습니다",
        "cardNoLetterDesc": "미래의 나에게 응원의 메시지를 남겨보세요!",
        "writeLetterBtn": "편지 쓰기",
        "cardSealedTitle": "Day {days} 타임캡슐 봉인 중",
    ...
    "apiErrors": {
        ...
        "EXPIRED_INVITE_LINK": "이 초대 링크는 만료되었습니다. 초대해 준 그룹 멤버에게 새 링크를 요청하세요.",
    ...
    "story": {
        ...
        "personalStudyTitle": "개인 경전 연구",
        "personalStudyDesc": "개발자가 개인적으로 진행 중인 경전(이사야서 및 몰몬경) 연구 노트를 GitHub에 공개하고 있습니다(일본어 전용). 관심 있으신 분은 참고용으로 확인해 보세요.",
    ...
    "dashboard": {
        ...
        "joinCreateGroup": "그룹 가입/생성",
        "rejoinGroupPrompt": "\"{groupName}\"에 다시 참여하시겠습니까?",
        "rejoinAiGroupPrompt": "스크립처 해빗 AI 그룹을 다시 시작하시겠습니까?",
        "rejoinBtn": "다시 참여하기",
        "rejoiningBtn": "참여 중...",
        "findOrCreateOtherGroup": "다른 그룹 찾기/생성",
        "rejoinSuccess": "그룹에 다시 참여했습니다!",
        "groupFullRejoin": "죄송합니다! 이 그룹은 현재 정원이 찼습니다 💦",
        "groupDeletedRejoin": "이 그룹은 이미 삭제되었습니다.",
        "notificationPrompt": {
            "title": "소식을 받아보세요!",
    ...
    "groupChat": {
        ...
        "inviteNoExpiration": "유효기간: 무제한 (언제든지 참여 가능)",
    ...
    "joinGroup": {
        ...
        "invalidInviteTitle": "초대 링크를 찾을 수 없음",
        "goBackHome": "홈으로 돌아가기",
    ...
    "landing": {
        ...
        "concept": {
            ...
            "subtitle": "모두와 함께 서로 격려하며 배울 수도, AI와 함께 부담 없이 나만의 속도로 배울 수도 있습니다.",
            "problemBadge": "계속하기 어려워요",
            "solutionBadge": "즐겁게 계속해요!",
            "aiBadge": "혼자라도 안심!",
            "twoWaysLabel": "습관을 만드는 2가지 방법",
            "card1Title": "혼자 공부할 때는...",
            "card1Text": "바쁜 하루에 밀려 학습이 뒤로 미뤄지기 쉽고, 어느새 중단되기 쉽습니다.",
            "card2Title": "친구와 함께!",
            "card2Text": "서로를 다정히 격려하고 느낀 점을 말로 표현하면 자연스럽게 습관이 됩니다.",
            "card3Title": "혼자라면 AI와 함께!",
            "card3Text": "함께 배울 친구가 없어도 괜찮습니다. 스크하비 AI가 매일 노트를 올리며 당신만의 페이스로 다정하게 함께합니다."
        },
        "aiLetter": {
            "title": "혼자여도 외롭지 않게, AI가 보내는 '되돌아보기 편지'",
            "subtitle": "노트를 2번 작성할 때마다 AI가 경전 속 인물이 되어 나에게 공감해 주는 따뜻한 편지를 써 줍니다."
        },
        "steps": {
            "title": "사용 방법",
            "step1Title": "1. 그룹 만들기",
            "step1Desc": "함께 경전을 공부하고 싶은 사람들과 함께, 또는 AI와 함께 그룹을 만들어 보세요.",
