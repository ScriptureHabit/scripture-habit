export default {
    "milestone": {
        ...
        "label": "Study Record",
        "daysUnit": "DAYS",
        "speechBubbleLine1": "Congrats on {days} days! 🎉",
        "speechBubbleLine2": "Amazing work!",
    ...
    "timeCapsule": {
        ...
        "socialProofChallengers": "Companions around the world are aiming for Day {days}!",
        "letterSectionTitle": "Letter to Yourself on Day {days}",
        "letterSectionDesc": "Write your thoughts, feelings, and encouragement for when you reach this goal",
        "letterPlaceholder": "Congratulations on 10 days! It might have been tricky at first, but you kept going. Let's keep having fun studying on the way to Day 25!",
        "sosSectionTitle": "Emergency SOS Reminder",
        "sosSectionDesc": "A short note from your past self delivered on days your habit might break",
        "sosPlaceholder": "Remember why you started! Even reading just one verse today is a big win!",
        "sealButton": "Seal Time Capsule",
        "sealing": "Sealing...",
        "sealedSuccess": "Time Capsule for Day {days} has been sealed!",
        "charCount": "{current}/{max} characters",
        "minCharWarning": "Please write at least 5 characters for the letter and 3 for the SOS note",
        "unlockTitle": "Time Capsule Unlocked!",
        "unlockSubtitle": "Congratulations on Day {days}! A letter from your past self has arrived",
        "fromPastSelf": "A Letter from Your Past Self",
        "createdOn": "Written on: {date} (Back then: Day {days} / Lv.{level})",
        "savedToLetterBoxArchive": "This letter has been permanently archived in your Letter Box",
        "writeNextLetter": "Write a Letter for Day {nextDays}",
        "cardNoLetterTitle": "No letter for Day {days} yet",
        "cardNoLetterDesc": "Send a message of encouragement to your future self!",
        "writeLetterBtn": "Write Letter",
        "cardSealedTitle": "Time Capsule for Day {days} is Sealed",
    ...
    "story": {
        ...
        "personalStudyTitle": "Personal Scripture Study",
        "personalStudyDesc": "Personal study notes on the scriptures (Isaiah & Book of Mormon) maintained by the developer, published on GitHub (Japanese only). Feel free to check them out as a reference if you are interested.",
        "isaiahTitle": "Personal Isaiah Study",
    ...
    "dashboard": {
        ...
        "rejoinGroupPrompt": "Would you like to rejoin \"{groupName}\"?",
        "rejoinAiGroupPrompt": "Would you like to restart your Scripture Habit AI group?",
        "rejoinBtn": "Rejoin Group",
        "rejoiningBtn": "Rejoining...",
        "findOrCreateOtherGroup": "Find or Create Another Group",
        "rejoinSuccess": "You have rejoined the group!",
        "groupFullRejoin": "Sorry, this group is currently full 💦",
        "groupDeletedRejoin": "This group has already been deleted.",
        "notificationPrompt": {
