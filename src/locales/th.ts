export default {
    "milestone": {
        ...
        "daysUnit": "DAYS",
        "speechBubbleLine1": "ยินดีด้วยกับ {days} วัน! 🎉",
        "speechBubbleLine2": "สุดยอดมาก!",
    ...
    "levelUp": {
        ...
        "achievementMessage": "ยินดีด้วย!\nคุณถึงระดับ {level} แล้ว! ✨",
        "saveImage": "บันทึกรูปภาพ",
        "saving": "กำลังบันทึก...",
        "imageSaved": "บันทึกรูปภาพสำเร็จแล้ว",
        "imageSaveError": "บันทึกรูปภาพไม่สำเร็จ",
    ...
    "timeCapsule": {
        ...
        "socialProofChallengers": "เพื่อนร่วมทางทั่วโลกกำลังมุ่งมั่นสู่วันที่ {days}!",
        "letterSectionTitle": "จดหมายถึงตัวเองในวันที่ {days}",
        "letterSectionDesc": "เขียนความรู้สึกและกำลังใจสำหรับตอนที่คุณบรรลุเป้าหมายนี้",
        "letterPlaceholder": "ยินดีด้วยที่ครบ 10 วัน! ในตอนแรกอาจจะยาก แต่คุณก็ก้าวผ่านมาได้ มาสนุกกับการศึกษาต่อไปสู่วันที่ 25 กันเถอะ!",
        "sosSectionTitle": "ข้อความเตือนใจยามฉุกเฉิน (SOS)",
        "sosSectionDesc": "ข้อความสั้นๆ จากตัวคุณในอดีตที่จะส่งถึงคุณในวันที่นิสัยของคุณอาจหยุดชะงัก",
        "sosPlaceholder": "จำไว้ว่าทำไมคุณถึงเริ่มต้น! แม้แค่อ่านเพียงข้อเดียวในวันนี้ก็คือชัยชนะที่ยิ่งใหญ่แล้ว!",
        "sealButton": "ผนึกไทม์แคปซูล",
        "sealing": "กำลังผนึก...",
        "sealedSuccess": "ไทม์แคปซูลสำหรับวันที่ {days} ถูกผนึกเรียบร้อยแล้ว!",
        "charCount": "{current}/{max} ตัวอักษร",
        "minCharWarning": "กรุณาเขียนอย่างน้อย 5 ตัวอักษรสำหรับจดหมาย และ 3 ตัวอักษรสำหรับข้อความ SOS",
        "unlockTitle": "เปิดไทม์แคปซูลแล้ว!",
        "unlockSubtitle": "ยินดีด้วยสำหรับวันที่ {days}! จดหมายจากตัวคุณในอดีตมาถึงแล้ว",
        "fromPastSelf": "จดหมายจากตัวคุณในอดีต",
        "createdOn": "เขียนเมื่อ: {date} (ขณะนั้น: วันที่ {days} / เลเวล {level})",
        "savedToLetterBoxArchive": "จดหมายนี้ถูกเก็บถาวรไว้ในกล่องจดหมายของคุณแล้ว",
        "writeNextLetter": "เขียนจดหมายสำหรับวันที่ {nextDays}",
        "cardNoLetterTitle": "ยังไม่มีจดหมายสำหรับวันที่ {days}",
        "cardNoLetterDesc": "ส่งข้อความให้กำลังใจตัวเองในอนาคต!",
        "writeLetterBtn": "เขียนจดหมาย",
        "cardSealedTitle": "ไทม์แคปซูลวันที่ {days} ถูกผนึกอยู่",
    ...
    "story": {
        ...
        "redditCommunity": "ชุมชน Reddit",
        "personalStudyTitle": "การศึกษาพระคัมภีร์ส่วนตัว",
        "personalStudyDesc": "บันทึกการศึกษาส่วนตัวเกี่ยวกับพระคัมภีร์ (อิสยาห์และพระคัมภีร์มอรมอน) ที่พัฒนาโดยผู้พัฒนาและเผยแพร่บน GitHub (ภาษาญี่ปุ่นเท่านั้น) หากสนใจสามารถเข้ามาดูเพื่อเป็นข้อมูลอ้างอิงได้",
        "isaiahTitle": "การศึกษาอิสยาห์ส่วนตัว",
    ...
    "dashboard": {
        ...
        "joinCreateGroup": "เข้าร่วม/สร้างกลุ่ม",
        "rejoinGroupPrompt": "คุณต้องการเข้าร่วม \"{groupName}\" อีกครั้งหรือไม่?",
        "rejoinAiGroupPrompt": "คุณต้องการเริ่มกลุ่ม Scripture Habit AI ใหม่อีกครั้งหรือไม่?",
        "rejoinBtn": "เข้าร่วมอีกครั้ง",
        "rejoiningBtn": "กำลังเข้าร่วม...",
        "findOrCreateOtherGroup": "ค้นหาหรือสร้างกลุ่มอื่น",
        "rejoinSuccess": "คุณได้เข้าร่วมกลุ่มอีกครั้งแล้ว!",
        "groupFullRejoin": "ขออภัย กลุ่มนี้เต็มแล้วในขณะนี้ 💦",
        "groupDeletedRejoin": "กลุ่มนี้ถูกลบไปแล้ว",
        "notificationPrompt": {
    ...
    "onboardingQuest": {
        ...
        "demoSeedMessage1": "ยินดีต้อนรับสู่อาหารประจำวัน! มาสนับสนุนและให้กำลังใจกันในการอ่านพระคัมภีร์ทุกวันนะ 🎉",
    ...
    "terms": {
        ...
        "aiDisclaimerItems": "Scripture Habit ใช้ AI (Google Gemini) สำหรับจดหมายสะท้อนความคิดและการแปลภาษา จดหมายสะท้อนความคิดของ AI มีไว้เพื่อให้กำลังใจในการศึกษาประจำวันโดยการใคร่ครวญถึงศรัทธาของบุคคลในพระคัมภีร์ และไม่ได้ทดแทนการเปิดเผยส่วนตัวจากพระวิญญาณบริสุทธิ์หรือการนำทางอย่างเป็นทางการของศาสนจักร เนื่องจาก AI อาจมีข้อผิดพลาด โปรดใช้วิจารณญาณพร้อมการสวดอ้อนวอนและอ้างอิงแหล่งข้อมูลทางการของศาสนจักรเพื่อความถูกต้องของหลักคำสอน",
    ...
    "landing": {
        ...
        "concept": {
            ...
            "subtitle": "ไม่ว่าจะให้กำลังใจซึ่งกันและกันกับทุกคน หรือเรียนรู้ตามจังหวะของตนเองอย่างสบายใจกับ AI คุณก็สามารถสร้างนิสัยที่ยั่งยืนได้",
            "problemBadge": "ทำต่อได้ยาก",
            "solutionBadge": "ง่ายและสนุก!",
            "aiBadge": "เรียนคนเดียวก็อุ่นใจ!",
            "twoWaysLabel": "2 วิธีในการสร้างนิสัย",
            ...
            "card3Title": "อยู่คนเดียว? เรียนกับ AI!",
            "card3Text": "ไม่มีเพื่อนร่วมเรียนก็ไม่เป็นไร Scripture Habit AI จะโพสต์โน้ตทุกวันและคอยเป็นเพื่อนร่วมทางตามจังหวะของคุณเอง"
        },
        "aiLetter": {
            "title": "ไม่เดียวดายอีกต่อไป: 'จดหมายทบทวนใจ' จาก AI",
            "subtitle": "ทุกครั้งที่คุณเขียนโน้ตครบ 2 ครั้ง AI จะสวมบทบาทเป็นบุคคลในพระคัมภีร์ เพื่อเขียนจดหมายอันอบอุ่นที่คอยเคียงข้างคุณ"
        },
        "steps": {
            "title": "วิธีการใช้งาน",
            "step1Title": "1. สร้างกลุ่ม",
            "step1Desc": "ลองสร้างกลุ่มร่วมกับคนที่คุณอยากศึกษาพระคัมภีร์ด้วย หรือจะร่วมกับ AI ก็ได้",
        ...
        "seoContent": {
            "faq": {
                ...
                "q1": "แอปนี้ฟรีหรือไม่?",
                "a1": "ใช่ แอปนี้สามารถใช้งานได้ฟรีโดยสมบูรณ์",
                ...
                "q4": "ทำไมถึงเป็นโอเพ่นซอร์ส?",
                "a4": "เพื่อให้มั่นใจในความโปร่งใสและสร้างความสบายใจเกี่ยวกับวิธีการจัดการข้อมูลและการทำงานของแอป ซอร์สโค้ดทั้งหมดเปิดเผยต่อสาธารณะบน GitHub และเรายินดีรับข้อเสนอแนะและการมีส่วนร่วมจากชุมชนเสมอ"
            }
        }
    },
    "demo": {
