export default {
    "milestone": {
        ...
        "daysUnit": "DIAS",
        "speechBubbleLine1": "Parabéns pelos {days} dias! 🎉",
        "speechBubbleLine2": "Incrível!",
    ...
    "timeCapsule": {
        ...
        "socialProofCount": "{count} companheiros alcançaram o Dia {days}!",
        "socialProofChallengers": "Companheiros ao redor do mundo estão buscando o Dia {days}!",
        "letterSectionTitle": "Carta para o seu eu do Dia {days}",
        "letterSectionDesc": "Escreva seus pensamentos, sentimentos e incentivo para quando alcançar esta meta",
        "letterPlaceholder": "Parabéns pelos 10 dias! Pode ter sido difícil no começo, mas você continuou firme. Vamos continuar aproveitando o estudo rumo ao Dia 25!",
        "sosSectionTitle": "Lembrete SOS de emergência",
        "sosSectionDesc": "Uma mensagem curta do seu eu do passado enviada nos dias em que seu hábito possa fraquejar",
        "sosPlaceholder": "Lembre-se de por que você começou! Ler nem que seja um único versículo hoje já é uma grande vitória!",
        "sealButton": "Selar cápsula do tempo",
        "sealing": "Selando...",
        "sealedSuccess": "A cápsula do tempo para o Dia {days} foi selada!",
        "charCount": "{current}/{max} caracteres",
        "minCharWarning": "Escreva pelo menos 5 caracteres para a carta e 3 para a mensagem de SOS",
        "unlockTitle": "Cápsula do tempo aberta!",
        "unlockSubtitle": "Parabéns pelo Dia {days}! Uma carta do seu eu do passado chegou",
        "fromPastSelf": "Uma carta do seu eu do passado",
        "createdOn": "Escrito em: {date} (Na época: Dia {days} / Nível {level})",
        "savedToLetterBoxArchive": "Esta carta foi arquivada permanentemente na sua Caixa de Cartas",
        "writeNextLetter": "Escrever uma carta para o Dia {nextDays}",
        "cardNoLetterTitle": "Ainda não há carta para o Dia {days}",
        "cardNoLetterDesc": "Envie uma mensagem de encorajamento para seu futuro eu!",
        "writeLetterBtn": "Escrever carta",
        "cardSealedTitle": "A cápsula do tempo para o Dia {days} está selada",
    ...
    "apiErrors": {
        ...
        "EXPIRED_INVITE_LINK": "Este link de convite expirou. Por favor, peça a um membro do grupo que lhe envie um novo.",
    ...
    "story": {
        ...
        "personalStudyTitle": "Estudo pessoal das Escrituras",
        "personalStudyDesc": "Notas de estudo pessoal sobre as Escrituras (Isaías e Livro de Mórmon) mantidas pelo desenvolvedor e publicadas no GitHub (somente em japonês). Sinta-se à vontade para consultá-las como referência se estiver interessado.",
        ...
        "isaiahBtn": "Estudo de Isaías (GitHub)",
        "bookOfMormonBtn": "Estudo do Livro de Mórmon (GitHub)",
    ...
    "dashboard": {
        ...
        "rejoinGroupPrompt": "Gostaria de entrar novamente em \"{groupName}\"?",
        "rejoinAiGroupPrompt": "Gostaria de reiniciar seu grupo de IA do Scripture Habit?",
        "rejoinBtn": "Entrar novamente",
        "rejoiningBtn": "Entrando...",
        "findOrCreateOtherGroup": "Encontrar ou criar outro grupo",
        "rejoinSuccess": "Você entrou novamente no grupo!",
        "groupFullRejoin": "Desculpe, este grupo está cheio no momento 💦",
        "groupDeletedRejoin": "Este grupo já foi excluído.",
        "notificationPrompt": {
    ...
    "myNotes": {
        ...
        "noNotesForRecap": "Publique pelo menos 2 notas para gerar uma carta.",
        "recapError": "Falha ao gerar carta.",
    ...
    "recapModal": {
        "title": "Carta de Reflexão",
        "subtitle": "Uma reflexão sobre suas anotações de estudo recentes.",
        "close": "Fechar",
        "savedToLetterBox": "Salvo na caixa de cartas"
    },
    "letterBox": {
        ...
        "empty": "Nenhuma carta ainda. Publique 2 notas para receber uma carta de reflexão!",
        "defaultTitle": "Carta de Reflexão",
        "autoDeleteNotice": "As cartas serão excluídas automaticamente 30 dias após a geração.",
        "welcomeLetterTitle": "Bem-vindo ao Scripture Habit",
        "welcomeLetterContent": "Seja muito bem-vindo(a), {nickname}.\n\nNa correria do dia a dia, abrir as escrituras e voltar o coração para a palavra sagrada pode, às vezes, parecer um pequeno desafio. No entanto, mesmo lendo apenas um versículo por dia ou escrevendo uma breve reflexão, essa pequena constância certamente trará verdadeira paz e luz para a sua vida.\n\nApós publicar 2 notas, você receberá uma carta especial de reflexão sobre seus aprendizados e impressões. Convidamos você a registrar o que sentiu hoje na sua primeira anotação!\n\nQue sua vida seja repleta de abundantes bênçãos e alegria.\n\n— Do desenvolvedor do Scripture Habit"
    },
    "groupChat": {
        ...
        "inviteNoExpiration": "Expira: Nunca (Sempre ativo)",
    ...
    "groupOptions": {
        "aiGroupAlreadyJoinedBadge": "Ingressou",
        "aiGroupAlreadyJoinedNote": "* Você só pode participar de 1 grupo do Scripture Habit AI por vez.",
    ...
    "joinGroup": {
        ...
        "invalidInviteTitle": "Link de Convite Não Encontrado",
    ...
    "welcomeGuideButton": "Entendi!",
    "mascot": {
        "aiGroupAlreadyJoinedPrompt": "Você já está em um grupo do Scripture Habit AI! Vamos explorar outros grupos.",
    ...
    "terms": {
        ...
        "aiDisclaimerItems": "O Scripture Habit usa IA (Google Gemini) para cartas de reflexão e traduções. As cartas de reflexão de IA destinam-se a incentivar seu estudo diário refletindo sobre a fé das figuras das Escrituras e não substituem a revelação pessoal do Espírito Santo ou a orientação oficial da Igreja. Como a IA pode cometer erros, use seu próprio discernimento em oração e os recursos oficiais da Igreja para precisão doutrinária.",
