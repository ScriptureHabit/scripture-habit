export default {
    "milestone": {
        ...
        "daysUnit": "DÍAS",
        "speechBubbleLine1": "¡Felicitaciones por los {days} días! 🎉",
        "speechBubbleLine2": "¡Increíble!",
    ...
    "levelUp": {
        ...
        "speechBubbleLine1": "¡Felicitaciones por el Nivel {level}! ✨",
        "speechBubbleLine2": "¡Genial!",
        "achievementMessage": "¡Felicitaciones!\n¡Has alcanzado el Nivel {level}! ✨",
        "saveImage": "Guardar imagen",
        "saving": "Guardando...",
        "imageSaved": "Imagen guardada con éxito",
        "imageSaveError": "Error al guardar la imagen",
    ...
    "timeCapsule": {
        ...
        "cardSealedBadgeRemaining": "Quedan {remaining} días",
        "cardSealedBadgeOpeningSoon": "¡Apertura próxima!",
        "toMyselfTitle": "A mí mismo en el Día {days}"
    },
    "_meta": {
        "code": "es",
        "name": "Español",
    ...
    "story": {
        ...
        "personalStudyTitle": "Estudio personal de las Escrituras",
        "personalStudyDesc": "Notas de estudio personal sobre las Escrituras (Isaías y Libro de Mormón) mantenidas por el desarrollador y publicadas en GitHub (solo en japonés). Si le interesa, puede consultarlas como referencia.",
        "isaiahTitle": "Estudio personal de Isaías",
        "isaiahDesc": "Notas de estudio personal sobre el libro de Isaías mantenidas por el desarrollador y publicadas en GitHub (solo en japonés). Si le interesa, puede consultarlas como referencia.",
        "isaiahBtn": "Estudio de Isaías (Sitio web)",
        "bookOfMormonBtn": "Estudio del Libro de Mormón (Sitio web)",
    ...
    "dashboard": {
        ...
        "rejoinGroupPrompt": "¿Te gustaría volver a unirte a \"{groupName}\"?",
        "rejoinAiGroupPrompt": "¿Te gustaría reiniciar tu grupo de IA de Scripture Habit?",
        "rejoinBtn": "Volver a unirse",
        "rejoiningBtn": "Uniéndose...",
        "findOrCreateOtherGroup": "Buscar o crear otro grupo",
        "rejoinSuccess": "¡Te has vuelto a unir al grupo!",
        "groupFullRejoin": "Lo sentimos, este grupo está lleno actualmente 💦",
        "groupDeletedRejoin": "Este grupo ya ha sido eliminado.",
        "notificationPrompt": {
    ...
    "groupChat": {
        ...
        "inactivityPolicyBanner": "⚠️ Si no publica una nota o mensaje en este grupo durante {days} días, será eliminado automáticamente.",
        "placeholderShare": "¡Compartamos lo que aprendió hoy!",
        "placeholderInactivity": "⚠️ La inactividad durante {days} días conducirá a la eliminación automática.",
        ...
        "errorToggleReaction": "Error al actualizar la reacción.",
        "inviteFriends": "Invitar amigos",
        "reTranslate": "Volver a traducir",
        "retrySend": "Reintentar envío",
        "retry": "Reintentar",
        "sending": "Enviando...",
        "userKicked": "⚠️ **{nickname}** fue eliminado/a del grupo."
    },
    "newNote": {
        ...
        "chapterPlaceholder": [
            ...
            "ej: 1 Nefi 3:7",
            "ej: Mateo 11:28",
            "ej: 88:125 (para Doctrina y Convenios)",
            "ej: Alma 32:21",
            "ej: Mosíah 2:17",
            "ej: Jacob 1:5"
        ],
        ...
        "commentPlaceholder": [
            ...
            "ej: 30 minutos de scrolling no son nada, pero leer las escrituras parece una eternidad. Las escrituras son la Sala del Tiempo para el espíritu.",
            "ej: Si pudiera concentrarme en el estudio tanto como mi gato se concentra en interrumpirme, ya habría vencido al mundo.",
            "ej: ¿Alguna vez has leído la misma parte varias veces y has pensado: '¿Espera, esto siempre estuvo aquí?'",
            "ej: Parece que el 'Ven, sígueme' de esta semana es más largo de lo habitual.",
            "ej: Quien escribió las Planchas de Latón tenía un encanto misterioso, ¿quién habrá sido...?",
            "ej: ¿Qué tan alta era la fiebre de Zeezrom? Debía estar muy caliente.",
            "ej: Barcos jareditas, 'ajustados como un plato'... ¿qué forma será esa exactamente?",
            "ej: La expectativa de '¡las ventanas de los cielos se abrirán!' vs. la ligereza de mi cartera después de pagar el diezmo.",
            "ej: Ammón hijo de Mosíah, Ammón de la expedición, Ammón hijo de Helamán...",
            "ej: Fulano engendró a Zutano, que engendró a Mengano... perdí el conocimiento en la zona de genealogías.",
            "ej: Ese misterioso sentimiento de alivio cuando un Apóstol toma un sorbo de agua durante su discurso.",
            "ej: Cuando el coro se levanta y piensas '¿Ah, un himno?', pero el discurso continúa.",
            "ej: Los discípulos debían estar en un estado de 'miau' total (como el gato en el espacio) a estas alturas...",
            "ej: Coriantón está viendo cómo su oscuro pasado queda expuesto para toda la posteridade aquí."
        ],
    ...
    "landing": {
        ...
        "openSource": {
            ...
            "redditBtn": "Comunidad de Reddit"
        },
        "seoContent": {
            "faq": {
                "title": "Preguntas frecuentes",
                "q1": "¿Esta aplicación es gratuita?",
                "a1": "Sí, esta aplicación es completamente gratuita.",
                ...
                "q4": "¿Por qué es de código abierto?",
                "a4": "Para garantizar una total transparencia y tranquilidad en el tratamiento de los datos y el funcionamiento de la aplicación. Todo el código fuente está disponible públicamente en GitHub, y agradecemos los comentarios y contribuciones de la comunidad."
            }
        }
    },
    "demo": {
    ...
    "urlStudy": {
        "modeUrl": "URL",
        "prompt": "Ingresa la URL de la Biblioteca del Evangelio o de un discurso para registrar tu estudio de hoy",
        "urlInputPlaceholder": "Pegar URL (https://...)",
        "commentLabel": "Comentario (editable)",
        "commentPlaceholder": "Pensamientos o impresiones...",
        "fetchingInfo": "Obteniendo detalles de la URL...",
        "completeButton": "Completar",
        "submitting": "Guardando...",
        "successMessage": "¡Estudio de hoy registrado! 🎉",
        "errorMessage": "No se pudo registrar el estudio. Inténtalo de nuevo.",
