export default {
    "milestone": {
        ...
        "daysUnit": "NGÀY",
        "speechBubbleLine1": "Chúc mừng {days} ngày! 🎉",
        "speechBubbleLine2": "Thật tuyệt vời!",
    ...
    "levelUp": {
        ...
        "speechBubbleLine1": "Chúc mừng đạt Cấp {level}! ✨",
        "speechBubbleLine2": "Xuất sắc lắm!",
        "achievementMessage": "Chúc mừng!\nBạn đã đạt Cấp {level}! ✨",
        "saveImage": "Lưu hình ảnh",
        "saving": "Đang lưu...",
        "imageSaved": "Đã lưu hình ảnh thành công",
        "imageSaveError": "Không thể lưu hình ảnh",
    ...
    "timeCapsule": {
        ...
        "socialProofChallengers": "Các bạn đồng hành trên toàn thế giới đang nỗ lực đạt Ngày {days}!",
        "letterSectionTitle": "Thư gửi chính bạn vào Ngày {days}",
        "letterSectionDesc": "Hãy viết lại cảm xúc, suy nghĩ và lời động viên khi bạn đạt được mục tiêu này",
        "letterPlaceholder": "Chúc mừng bạn đạt 10 ngày! Ban đầu có thể khó khăn khi mở thánh thư mỗi ngày, nhưng bạn đã kiên trì. Hãy tiếp tục vui vẻ tiến tới Ngày 25 nhé!",
        "sosSectionTitle": "Lời nhắc SOS khẩn cấp",
        "sosSectionDesc": "Lời nhắn ngắn từ bạn trong quá khứ gửi đến vào những ngày bạn có nguy cơ bỏ cuộc",
        "sosPlaceholder": "Hãy nhớ lại lý do bạn bắt đầu! Dù chỉ đọc 1 câu hôm nay thôi cũng là một bước tiến lớn!",
        "sealButton": "Niêm phong hộp thời gian",
        "sealing": "Đang niêm phong...",
        "sealedSuccess": "Hộp thời gian cho Ngày {days} đã được niêm phong thành công!",
        "charCount": "{current}/{max} ký tự",
        "minCharWarning": "Vui lòng nhập ít nhất 5 ký tự cho bức thư và 3 ký tự cho lời nhắn SOS",
        "unlockTitle": "Mở hộp thời gian!",
        "unlockSubtitle": "Chúc mừng bạn đã đạt Ngày {days}! Một bức thư từ quá khứ đã được gửi tới bạn",
        "fromPastSelf": "Bức thư từ chính bạn trong quá khứ",
        "createdOn": "Được viết vào: {date} (Lúc đó: Ngày {days} / Cấp {level})",
        "savedToLetterBoxArchive": "Bức thư này đã được lưu trữ vĩnh viễn trong Hộp thư của bạn",
        "writeNextLetter": "Viết thư gửi Ngày {nextDays}",
        "cardNoLetterTitle": "Chưa có thư cho Ngày {days}",
        "cardNoLetterDesc": "Hãy gửi lời động viên tới bản thân trong tương lai!",
        "writeLetterBtn": "Viết thư",
        "cardSealedTitle": "Hộp thời gian Ngày {days} đang niêm phong",
        "cardSealedDesc": "Hiện tại Ngày {current} / Mở sau {remaining} ngày nữa",
        "cardSosTitle": "Lời nhắn từ quá khứ của bạn",
        "postNowBtn": "Đăng ghi chú ngay",
        "cardSealedBadgeRemaining": "Còn {remaining} ngày",
        "cardSealedBadgeOpeningSoon": "Sắp mở!",
        "toMyselfTitle": "Gửi bản thân vào Ngày {days}"
    },
    "_meta": {
        "code": "vi",
        "name": "Tiếng Việt",
    ...
    "apiErrors": {
        "INVALID_INVITE_CODE": "Mã mời không hợp lệ hoặc đã hết hạn.",
        ...
        "MAX_GROUPS_LIMIT": "Bạn chỉ có thể tham gia tối đa 4 nhóm. Vui lòng rời bớt nhóm khác trước.",
        "NETWORK_ERROR": "Lỗi mạng. Vui lòng kiểm tra kết nối internet của bạn.",
        "VALIDATION_ERROR": "Dữ liệu nhập không hợp lệ.",
        "CONFLICT": "Đã xảy ra xung đột dữ liệu.",
        "UNAUTHENTICATED": "Yêu cầu xác thực tài khoản.",
        "SERVICE_UNAVAILABLE": "Dịch vụ tạm thời không khả dụng.",
        "APP_CHECK_MISSING": "Thiếu mã thông báo App Check.",
        "APP_CHECK_FAILED": "Xác minh App Check thất bại.",
        "INVALID_TOKEN": "Phiên làm việc đã hết hạn. Vui lòng đăng nhập lại.",
        "auth/email-not-verified": "Địa chỉ email chưa được xác minh. Vui lòng kiểm tra hộp thư đến."
    },
    "common": {
        "cancel": "Hủy",
        "delete": "Xóa",
    ...
    "story": {
        ...
        "personalStudyTitle": "Nghiên cứu thánh thư cá nhân",
        "personalStudyDesc": "Ghi chú nghiên cứu cá nhân về thánh thư (Ê-sai và Sách Mặc Môn) do nhà phát triển duy trì và xuất bản trên GitHub (chỉ bằng tiếng Nhật). Hãy xem để tham khảo nếu bạn quan tâm.",
        ...
        "isaiahBtn": "Nghiên cứu Ê-sai (Trang web)",
        "bookOfMormonBtn": "Nghiên cứu Sách Mặc Môn (Trang web)",
    ...
    "dashboard": {
        ...
        "rejoinGroupPrompt": "Bạn có muốn tham gia lại \"{groupName}\" không?",
        "rejoinAiGroupPrompt": "Bạn có muốn khởi động lại nhóm AI Scripture Habit không?",
        "rejoinBtn": "Tham gia lại",
        "rejoiningBtn": "Đang tham gia...",
        "findOrCreateOtherGroup": "Tìm hoặc tạo nhóm khác",
        "rejoinSuccess": "Bạn đã tham gia lại nhóm thành công!",
        "groupFullRejoin": "Xin lỗi, nhóm này hiện đã đủ thành viên 💦",
        "groupDeletedRejoin": "Nhóm này đã bị xóa.",
        "notificationPrompt": {
            "title": "Luôn Kết Nối!",
    ...
    "profile": {
        ...
        "imageUploadSuccess": "Đã cập nhật ảnh đại diện thành công!",
        "imageUploadError": "Cập nhật ảnh đại diện thất bại.",
        "photoHint": "Nhấn để thay đổi ảnh đại diện",
        "imageTooLarge": "Kích thước ảnh quá lớn. Vui lòng chọn ảnh nhỏ hơn.",
        "notificationToggle": {
            "title": "Thông báo Đẩy",
    ...
    "groupChat": {
        ...
        "typeMessage": [
            "Nhấp nút + để tạo ghi chép hoặc nhập tin nhắn...",
            "Khó quá... câu này có ý nghĩa gì nhỉ? Có ai hiểu đoạn thánh thư này không?",
            "Chương này dài như bài nói chuyện của một Ủy viên Hội đồng Thượng phẩm...",
            "Thành thật mà nói, tôi đã ngủ quên trong các chương về chiến tranh...",
            "Tôi muốn có một Liahona cho cuộc đời mình... chứ không chỉ là Google Maps.",
            "Lại đâm sầm vào 'bức tường Ê Sai'... có lẽ tôi sẽ còn gặp lại điều này.",
            "Ma-he-sa-la-hách-bát... tôi chỉ muốn đọc thử cái tên này thôi.",
            "Tôi đã dốc lòng tìm kiếm sự khôn ngoan, nhưng điều đó cũng là hư không...",
            "Lại là Nê Phi... đây rốt cuộc là vị Nê Phi thứ mấy rồi...?",
            "Ủa? Hôm qua mình cũng đọc đúng phần này rồi mà nhỉ?",
            "Lướt mạng 30 phút trôi qua cái vèo, nhưng đọc thánh thư cảm giác dài như thiên thu. Thánh thư đúng là Phòng Thời Gian Tinh Thần.",
            "Nếu mình có thể tập trung học như cách con mèo tập trung quậy phá mình, chắc mình đã thắng thế gian rồi.",
            "Đã bao giờ bạn đọc đi đọc lại một đoạn rồi tự hỏi: 'Ủa, câu này có ở đây từ trước tới giờ à?'",
            "Cảm giác tài liệu 'Hãy Đến Mà Theo Thầy' tuần này dài hơn bình thường.",
            "Người khắc các Bảng Khắc Bằng Đồng có sức hút thật bí ẩn, không biết họ là ai nhỉ...?",
            "Cơn sốt của Giê Rôm cao đến mức nào nhỉ? Chắc là nóng lắm.",
            "Thuyền của người Gia Rết, 'kín như một cái dĩa'... rốt cuộc là hình thù gì vậy?",
            "Kỳ vọng 'các cửa sổ trên trời sẽ mở ra!' sau khi đóng tiền thập phân vs độ nhẹ tênh của cái ví.",
            "Am Môn con trai của Mô Si A, Am Môn của đoàn thám hiểm, Am Môn con trai của Hê La Man...",
            "Ai sinh ra ai, ai sinh ra ai... mình đã mất phương hướng trong vùng gia phả.",
            "Cảm giác an tâm kỳ lạ khi một Vị Sứ Đồ uống một ngụm nước trong bài nói chuyện.",
            "Khi ca đoàn đứng dậy và bạn nghĩ 'Ồ, hát bài ca à?', nhưng bài nói chuyện vẫn tiếp tục.",
            "Các môn đồ lúc này chắc hẳn đang ở trạng thái 'mèo vũ trụ' (sốc toàn tập)...",
            "Coi Rian Tôn thực sự đã bị phơi bày quá khứ đen tối cho muôn đời sau ở đây.",
            "Khoan đã, mình đang đọc tới đâu rồi...? ... (lật lật trang...) ... 'Tôi là Nê Phi, nhờ sinh ra từ cha mẹ tốt lành...'"
        ],
        "leaveGroup": "Rời nhóm",
        ...
        "errorToggleReaction": "Không thể cập nhật biểu cảm.",
    ...
    "newNote": {
        ...
        "chapterPlaceholder": [
            ...
            "vd: 1 Nê Phi 3:7",
            "vd: Ma Thi Ơ 11:28",
            "vd: 88:125 (đối với Giáo Lý và Giao Ước)",
            "vd: An Ma 32:21",
            "vd: Mô Si A 2:17",
            "vd: Gia Cốp 1:5"
        ],
        ...
        "commentPlaceholder": [
            "vd: Khó quá... câu này có ý nghĩa gì nhỉ? Có ai hiểu đoạn thánh thư này không?",
            "vd: Chương này dài như bài nói chuyện của một Ủy viên Hội đồng Thượng phẩm...",
            "vd: Thành thật mà nói, tôi đã ngủ quên trong các chương về chiến tranh...",
            "vd: Tôi muốn có một Liahona cho cuộc đời mình... chứ không chỉ là Google Maps.",
            "vd: Lại đâm sầm vào 'bức tường Ê Sai'... có lẽ tôi sẽ còn gặp lại điều này.",
            "vd: Ma-he-sa-la-hách-bát... tôi chỉ muốn đọc thử cái tên này thôi.",
            "vd: Tôi đã dốc lòng tìm kiếm sự khôn ngoan, nhưng điều đó cũng là hư không...",
            "vd: Lại là Nê Phi... đây rốt cuộc là vị Nê Phi thứ mấy rồi...?",
            "vd: Ủa? Hôm qua mình cũng đọc đúng phần này rồi mà nhỉ?",
            "vd: Lướt mạng 30 phút trôi qua cái vèo, nhưng đọc thánh thư cảm giác dài như thiên thu. Thánh thư đúng là Phòng Thời Gian Tinh Thần.",
            "vd: Nếu mình có thể tập trung học như cách con mèo tập trung quậy phá mình, chắc mình đã thắng thế gian rồi.",
            "vd: Đã bao giờ bạn đọc đi đọc lại một đoạn rồi tự hỏi: 'Ủa, câu này có ở đây từ trước tới giờ à?'",
            "vd: Cảm giác tài liệu 'Hãy Đến Mà Theo Thầy' tuần này dài hơn bình thường.",
            "vd: Người khắc các Bảng Khắc Bằng Đồng có sức hút thật bí ẩn, không biết họ là ai nhỉ...?",
            "vd: Cơn sốt của Giê Rôm cao đến mức nào nhỉ? Chắc là nóng lắm.",
            "vd: Thuyền của người Gia Rết, 'kín như một cái dĩa'... rốt cuộc là hình thù gì vậy?",
            "vd: Kỳ vọng 'các cửa sổ trên trời sẽ mở ra!' sau khi đóng tiền thập phân vs độ nhẹ tênh của cái ví.",
            "vd: Am Môn con trai của Mô Si A, Am Môn của đoàn thám hiểm, Am Môn con trai của Hê La Man...",
            "vd: Ai sinh ra ai, ai sinh ra ai... mình đã mất phương hướng trong vùng gia phả.",
            "vd: Cảm giác an tâm kỳ lạ khi một Vị Sứ Đồ uống một ngụm nước trong bài nói chuyện.",
            "vd: Khi ca đoàn đứng dậy và bạn nghĩ 'Ồ, hát bài ca à?', nhưng bài nói chuyện vẫn tiếp tục.",
            "vd: Các môn đồ lúc này chắc hẳn đang ở trạng thái 'mèo vũ trụ' (sốc toàn tập)...",
            "vd: Coi Rian Tôn thực sự đã bị phơi bày quá khứ đen tối cho muôn đời sau ở đây."
        ],
    ...
    "urlStudy": {
        "modeUrl": "URL",
        "prompt": "Nhập liên kết Thư Viện Phúc Âm hoặc bài nói chuyện để ghi lại việc học hôm nay",
        "urlInputPlaceholder": "Dán liên kết (https://...)",
        "commentLabel": "Bình luận (có thể chỉnh sửa)",
        "commentPlaceholder": "Suy nghĩ hoặc cảm nhận...",
        "fetchingInfo": "Đang lấy thông tin liên kết...",
        "completeButton": "Hoàn tất",
        "submitting": "Đang lưu...",
        "successMessage": "Đã ghi nhận buổi học hôm nay! 🎉",
        "errorMessage": "Không thể ghi nhận việc học. Vui lòng thử lại.",
