export default {
    "milestone": {
        ...
        "label": "学びの記録",
        "daysUnit": "DAYS",
        "speechBubbleLine1": "{days}日達成おめでとう！🎉",
    ...
    "timeCapsule": {
        ...
        "socialProofChallengers": "世界中の仲間がDay {days}を目指して挑戦中！",
        "letterSectionTitle": "Day {days}達成した自分への手紙",
        "letterSectionDesc": "達成した時の気持ちや、これからの自分への言葉を綴りましょう",
        "letterPlaceholder": "10日達成おめでとう！最初は毎日開くのが大変だったかもしれないけど、よくここまで続けたね。この調子で次の25日目も楽しく学ぼう！",
        "sosSectionTitle": "サボりそうな時の自分へのSOS一言",
        "sosSectionDesc": "習慣が途切れそうな日に届く、初心や励ましのメッセージです",
        "sosPlaceholder": "初心の「聖文を習慣にして心を満たしたい」って気持ちを思い出して！1行読むだけでもOKだから！",
        "sealButton": "タイムカプセルを封印する",
        "sealing": "封印中...",
        "sealedSuccess": "Day {days}のタイムカプセルを封印しました！",
        "charCount": "{current}/{max}文字",
        "minCharWarning": "本文は5文字以上、SOS一言は3文字以上入力してください",
        "unlockTitle": "タイムカプセル開封！",
        "unlockSubtitle": "Day {days}達成おめでとうございます！過去のあなたからの手紙が届きました",
        "fromPastSelf": "過去のあなたからの手紙",
        "createdOn": "作成日: {date} (当時: {days}日目 / Lv.{level})",
        "savedToLetterBoxArchive": "この手紙はレターボックスに永久保存されました",
        "writeNextLetter": "次のDay {nextDays}の自分へ手紙を書く",
        "cardNoLetterTitle": "Day {days}への手紙がまだありません",
        "cardNoLetterDesc": "未来の自分へ応援メッセージを届けよう！",
        "writeLetterBtn": "手紙を書く",
        "cardSealedTitle": "Day {days}のタイムカプセル封印中",
    ...
    "story": {
        ...
        "personalStudyTitle": "個人の聖典研究",
        "personalStudyDesc": "開発者が個人で進めている聖典（イザヤ書・モルモン書）の研究ノートをGitHubで公開しています（日本語のみ）。興味のある方は参考程度にご覧ください。",
    ...
    "dashboard": {
        ...
        "rejoinGroupPrompt": "もう一度「{groupName}」に参加しませんか？",
        "rejoinAiGroupPrompt": "スクハビAIグループを再開しませんか？",
        "rejoinBtn": "再参加する",
        "rejoiningBtn": "参加中...",
        "findOrCreateOtherGroup": "別のグループを探す・作成する",
        "rejoinSuccess": "グループに再参加しました！",
        "groupFullRejoin": "ごめんなさい！このグループは現在満員です💦",
        "groupDeletedRejoin": "このグループはすでに解散されています",
        "notificationPrompt": {
            "title": "学びを逃さないために",
    ...
    "landing": {
        ...
        "concept": {
            ...
            "subtitle": "みんなと一緒に励まし合うことも、AIと一緒に気軽に学ぶこともできます。",
            "problemBadge": "続かない",
            "solutionBadge": "楽しく続く！",
            "aiBadge": "一人でも安心！",
            "twoWaysLabel": "選べる2つの続け方",
            "card1Title": "ひとりの学習は...",
            "card1Text": "忙しい毎日に追われて後回しになり、いつの間にか途切れてしまいがちです。",
            "card2Title": "みんなと一緒に！",
            "card2Text": "お互いに優しく励まし合い、気づいたことを言葉にすることで、自然と習慣になります。",
            "card3Title": "一人ならAIと！",
            "card3Text": "一緒に学ぶ仲間がいなくても大丈夫。スクハビAIが毎日ノートを投稿し、あなたの学習をサポートします。"
        },
        "aiLetter": {
            "title": "一人でも寂しくない、AIが届ける「ふり返りレター」",
            "subtitle": "ノートを2回書くごとに、AIが聖典の登場人物になりきって、あなたに寄りそった温かい手紙を書いてくれます。"
        },
        "steps": {
            "title": "使い方",
            "step1Title": "1. グループを作る",
            "step1Desc": "一緒に聖典学習を頑張りたい人達、もしくはAIとグループを作ってみましょう。",
