...
- **検索 & フィルタリング**: 過去の学習ノートを一覧表示し、タグやキーワードですぐに検索できます。
- **AI 振り返り手紙（手紙箱）**: 投稿したノート内容をもとに、聖典のエピソードを交えた振り返り手紙を届けます。
- **未来の自分への手紙（タイムカプセル）**: 次のマイルストーン（Day 10, 25...）に向けた応援手紙やサボり防止のSOS一言を封印し、達成時に過去のスナップショットとともに開封します。
