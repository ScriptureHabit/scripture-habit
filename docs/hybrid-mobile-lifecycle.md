...
> [!TIP]
> **Interactive Architecture Tour**: [Open Live Tour (PWA Offline & Lifecycle)](https://htmlpreview.github.io/?https://github.com/ScriptureHabit/scripture-habit/blob/main/docs/public/architecture-tour.html?tour=tour-pwa&lang=en)
