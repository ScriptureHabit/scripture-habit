...
> [!TIP]
> **Interactive Architecture Tour**: [Open Live Tour (Habit Dashboard & Reset)](https://htmlpreview.github.io/?https://github.com/ScriptureHabit/scripture-habit/blob/main/docs/public/architecture-tour.html?tour=tour-dashboard&lang=en)
