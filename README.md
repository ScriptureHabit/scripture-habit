...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Node.js-%3E%3D22%20(LTS%2024)-5FA04E?style=for-the-badge&logo=nodedotjs" alt="Node.js" />
...
The full documentation site (generated by VitePress + TypeDoc) is available at:

- 🌐 **[Documentation Site (English)](https://scripturehabit.github.io/scripture-habit/)**
- 🌐 **[ドキュメントサイト（日本語）](https://scripturehabit.github.io/scripture-habit/ja/)**

> To run locally: `npm run docs:dev`
