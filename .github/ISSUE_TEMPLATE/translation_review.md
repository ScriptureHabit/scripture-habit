...
- **Suggested Improvement / Proper Gospel Term**:
  > (Paste your recommended phrasing here)
- **Key / Section (if known)**: (e.g. `landing.hero.subtitle`, `story.developerRole`, etc.)

---

### 2. Gospel Terminology & Church Usage Context
*Explain why the suggested phrasing better matches official church usage, scripture phrasing, or local natural expression:*
